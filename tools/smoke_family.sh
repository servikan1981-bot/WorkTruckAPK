...
for name, path in [('old', 'updates/candidates/606-fixed.json'), ('new', 'updates/candidates/607.json')]:
...
# The release must install over the exact stable 6.0.6 package without deleting data.
